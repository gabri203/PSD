...
int main( int argc, char *argv[])
{
	...
	char line[N];
	int arr_input1[N], arr_input2[N], arr_somma[N], arr_oracolo[N];
	int n_input1, n_input2, n_somma, n_oracolo, test, i;
	...
	for(i=1; fgets(line, N, fp_input)!=NULL; i++){
		...
		n_somma = somma_v(arr_input1, n_input1, arr_input2, n_input2, arr_somma);
		test = confronta_array(arr_somma, arr_oracolo, n_somma, n_oracolo);
